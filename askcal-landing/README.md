...
`askcal.lucenity.dev` — scroll-driven WebGL landing experience. Not a product
page, an experience.
...
```bash
python3 -m http.server 4173 -d askcal-landing
# → http://localhost:4173
```
...
- the hero ASKCAL wordmark heartbeat (`heartbeat-beat`)
