...
[![backend tests](https://img.shields.io/badge/backend%20tests-233%20passing-2A2724?style=flat-square)](askcal-api)
...
docker compose up -d
uv run pytest                 # 233 tests, no database required
```
