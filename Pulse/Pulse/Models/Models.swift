...
//  Pulse
//
//  Domain models matching pulse-api's contracts (camelCase JSON).
...
struct PulseTask: Identifiable, Codable, Equatable {
    let id: UUID
    var track: TrackKey
    var title: String
...
/// Recurring habit, backend-owned (pulse-api routines table). Fresh accounts
