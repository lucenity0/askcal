...
//  Pulse
//
//  Idle pixel companion for the Up Next card. Pure monochrome pixel grid —
//  '#' = full, '+' = 40% shade, ' ' = empty. One motif chosen per app open.
//  Purely decorative; encodes nothing.
//
