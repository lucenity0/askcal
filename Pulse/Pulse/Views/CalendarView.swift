...
//  Day: Pulse task blocks (plain surface cards) overlaid with external
...
struct CalendarView: View {
    ...
    @State private var dayTasks: [PulseTask] = []
    ...
    private var activeTasks: [PulseTask] { isToday ? store.scheduledTasks : dayTasks }
    ...
    private func startMinute(for task: PulseTask) -> Int? {
    ...
    private func durationMinutes(for task: PulseTask) -> Int {
    ...
    private var anytimeTasks: [PulseTask] {
